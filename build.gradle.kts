...
dependencies {
    ...
    implementation("gg.aquatic:KMenu:26.0.5")
    implementation("gg.aquatic:KMenu-serialization:26.0.5")
    ...
    implementation("gg.aquatic:KHolograms-serialization:26.0.1")
    ...
    runtimeDownload("org.jetbrains.kotlin:kotlin-reflect:2.3.21")
